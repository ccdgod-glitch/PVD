# -----------------------------------------------------------------
# 1. ต้องมีบรรทัดนี้ "ก่อน" เพื่อสร้างตัวแปร tab_steps ขึ้นมาก่อน
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# 2. จากนั้นจึงจะสามารถเรียกใช้ with tab_steps: ได้โดยไม่เออเร่อ
# -----------------------------------------------------------------
with tab_steps:
    st.markdown("### 📑 ตารางคำนวณและตรวจสอบ...")
    # ... โค้ดตารางคำนวณต่างๆ ...
with tab_steps:
